<x-app-layout>
    ...
    <div class="ideas-container space-y-6 my-6">
        <div class="idea-container bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 rounded-xl flex hover:shadow-card transition duration-150 ease-in cursor-pointer">
        ...
        <div class="idea-container bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 rounded-xl flex hover:shadow-card transition duration-150 ease-in cursor-pointer">
            <div class="border-r border-gray-100 dark:border-gray-500 px-5 py-8">
                <div class="text-center">
                    <div class="font-semibold text-2xl text-blue dark:text-blue">12</div>
                    <div class="text-gray-500 dark:text-gray-100">Votes</div>
                </div>

                <div class="mt-8">
                    <button class="w-20 border border-gray-200 hover:border-gray-400 bg-blue text-gray-800 dark:border-gray-900 dark:hover:border-gray-500 dark:bg-blue dark:text-gray-100 font-bold text-xs uppercase rounded-xl px-4 py-3 transition duration-150 ease-in">Vote</button>
                </div>
            </div>
            <div class="flex flex-1 px-2 py-6">
                <a href="#" class='flex-none'>
                ...
                <div class="mx-4 w-full">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <button class="bg-gray-100 hover:bg-gray-200 dark:bg-gray-900 hover:dark:bg-gray-800 rounded-full h-7 px-3 transition duration-150 ease-in relative">
                                <svg style="color: rgb(122, 122, 122);" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-three-dots" viewBox="0 0 16 16"> <path d="M3 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z" fill="#7a7a7a"></path> </svg>
                                <ul class="absolute w-48 text-left ml-4 font-semibold bg-white dark:bg-gray-600 shadow-dialog rounded-xl py-3">
            ...
            <div class="flex flex-1 px-2 py-6">
                ...
                <div class="mx-4 w-full">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2">
                            <div class="bg-red dark:bg-red text-xs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4">
                                Closed
                            </div>
                            <button class="bg-gray-100 hover:bg-gray-200 dark:bg-gray-900 hover:dark:bg-gray-800 rounded-full h-7 px-3 transition duration-150 ease-in relative">
                                <svg style="color: rgb(122, 122, 122);" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-three-dots" viewBox="0 0 16 16"> <path d="M3 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z" fill="#7a7a7a"></path> </svg>
            ...
            <div class="flex flex-1 px-2 py-6">
                ...
                <div class="mx-4 w-full">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2">
                            <div class="bg-green dark:bg-green text-xs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4">
                                Implemented
                            </div>
                            <button class="bg-gray-100 hover:bg-gray-200 dark:bg-gray-900 hover:dark:bg-gray-800 rounded-full h-7 px-3 transition duration-150 ease-in relative">
                                <svg style="color: rgb(122, 122, 122);" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-three-dots" viewBox="0 0 16 16"> <path d="M3 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z" fill="#7a7a7a"></path> </svg>
        ...
        <div class="idea-container bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 rounded-xl flex hover:shadow-card transition duration-150 ease-in cursor-pointer">
            ...
            <div class="flex flex-1 px-2 py-6">
                ...
                <div class="mx-4 w-full">
                    ...
                    <div class="text-gray-600 dark:text-gray-100 mt-3 line-clamp-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. </div>
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2">
                            <div class="bg-purple dark:bg-purple text-xs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4">
                                Considering
                            </div>
                            <button class="bg-gray-100 hover:bg-gray-200 dark:bg-gray-900 hover:dark:bg-gray-800 rounded-full h-7 px-3 transition duration-150 ease-in relative">
                                <svg style="color: rgb(122, 122, 122);" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-three-dots" viewBox="0 0 16 16"> <path d="M3 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z" fill="#7a7a7a"></path> </svg>
